            ...
            if (!price.isEmpty()) {       // Если radio input "price" не пустые
                ...
                if (price.equals("sorted_by_ascending_price")) { // Если содержимое radio input "price" это "sorted_by_ascending_price"
                    ...
                    if (!contract.isEmpty()) {      // Если содержимое radio input "contract" не пустое
                        ...
                        if (contract.equals("woman")) { // Если содержимое radio input "contract" это "woman"
                        ...
                        } else if (contract.equals("animals")) { // Если содержимое radio input "contract" это "animals"
                        ...
                        } else if (contract.equals("man")) {    // Если содержимое radio input "contract" это "man"
